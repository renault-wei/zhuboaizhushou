...
> - 更新时间：2026-09-10（档 A 音色接线批次 — ①换音色真生效（live 音色随场次透传 to 火山合成，修复「切音色无变化」）②预设音色真实试听（删 mock 占位，服务端真合成回 wav，克隆音色回落演示音色并如实提示）；克隆真复刻为档 B 付费项，UI 保留「复刻待接入」标注；App 版本 0.3.0+86 → +87；App 全量 144/144、服务端 330/330，见 §6 第 52 条）
